...
def fetch_response():
    try:
            ...
            try:
                ...
                for sub_category in sub_categories:
                    ...
                    for sub_cat_item in sub_cat_items:
                        ...
                        url_sub=f'https://api.us.misumi-ec.com/api/v1/series/search?lang=ENG&suppressResponseCode=true&applicationId=72c49146-6b86-4155-a63c-499b00972294&_=1724920070194&sessionId=undefined&field=%40search%2CseriesList.templateType&categoryCode={item_id[4]}&sort=1&allSpecFlag=0&page=1&brandModeFlag=1&pageSize=45'
        ...
        df = pd.DataFrame(data, columns=['Category','CategoryId' 'Subcategory', 'SubcategoryName','SubcategoryId','DepartmentCode','MinShipDays','MaxShipDays','SeriesCode','SeriesName','BrandCode','BrandName'])
